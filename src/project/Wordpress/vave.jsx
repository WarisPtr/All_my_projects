...
export default function vavecenter() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/vave1.png', thumb: '/ProjectCoverImage/wordpress/vave1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/vave2.png', thumb: '/ProjectCoverImage/wordpress/vave2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/vave3.png', thumb: '/ProjectCoverImage/wordpress/vave3.png', title: 'ภาพที่ 3' },
  ];
