...
export default function Drowning() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/e1.png', thumb: '/ProjectCoverImage/wordpress/e1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/e2.png', thumb: '/ProjectCoverImage/wordpress/e2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/e3.png', thumb: '/ProjectCoverImage/wordpress/e3.png', title: 'ภาพที่ 3' },
  ];
