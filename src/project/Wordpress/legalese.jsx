...
export default function Legalese() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/l1.png', thumb: '/ProjectCoverImage/wordpress/l1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/l2.png', thumb: '/ProjectCoverImage/wordpress/l2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/l3.png', thumb: '/ProjectCoverImage/wordpress/l3.png', title: 'ภาพที่ 3' },
    { id: 4, src: '/ProjectCoverImage/wordpress/l4.png', thumb: '/ProjectCoverImage/wordpress/l4.png', title: 'ภาพที่ 4' },
    { id: 5, src: '/ProjectCoverImage/wordpress/l5.png', thumb: '/ProjectCoverImage/wordpress/l5.png', title: 'ภาพที่ 5' },
    { id: 6, src: '/ProjectCoverImage/wordpress/l6.png', thumb: '/ProjectCoverImage/wordpress/l6.png', title: 'ภาพที่ 6' }
  ];
