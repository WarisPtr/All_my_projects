...
export default function Iscc() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/iscc1.png', thumb: '/ProjectCoverImage/wordpress/iscc1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/iscc2.png', thumb: '/ProjectCoverImage/wordpress/iscc2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/iscc3.png', thumb: '/ProjectCoverImage/wordpress/iscc3.png', title: 'ภาพที่ 3' },
    { id: 4, src: '/ProjectCoverImage/wordpress/iscc4.png', thumb: '/ProjectCoverImage/wordpress/iscc4.png', title: 'ภาพที่ 4' },
    { id: 5, src: '/ProjectCoverImage/wordpress/iscc5.png', thumb: '/ProjectCoverImage/wordpress/iscc5.png', title: 'ภาพที่ 5' },
    { id: 6, src: '/ProjectCoverImage/wordpress/iscc6.png', thumb: '/ProjectCoverImage/wordpress/iscc6.png', title: 'ภาพที่ 6' }
  ];
  ...
  return (
    <div>
      {/* Gallery Grid */}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4  mx-auto p-4">
