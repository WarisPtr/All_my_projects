...
export default function Rabmhao() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/rabmhao1.png', thumb: '/ProjectCoverImage/wordpress/rabmhao1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/rabmhao2.png', thumb: '/ProjectCoverImage/wordpress/rabmhao2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/rabmhao3.png', thumb: '/ProjectCoverImage/wordpress/rabmhao3.png', title: 'ภาพที่ 3' },
  ];
