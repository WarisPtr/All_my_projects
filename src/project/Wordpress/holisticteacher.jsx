...
export default function Holisticteacher() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/holi1.png', thumb: '/ProjectCoverImage/wordpress/holi1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/holi2.png', thumb: '/ProjectCoverImage/wordpress/holi2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/holi3.png', thumb: '/ProjectCoverImage/wordpress/holi3.png', title: 'ภาพที่ 3' },
  ];
