...
export default function Motif() {
  ...
  const images = [
    { id: 1, src: '/ProjectCoverImage/wordpress/motif1.png', thumb: '/ProjectCoverImage/wordpress/motif1.png', title: 'ภาพที่ 1' },
    { id: 2, src: '/ProjectCoverImage/wordpress/motif2.png', thumb: '/ProjectCoverImage/wordpress/motif2.png', title: 'ภาพที่ 2' },
    { id: 3, src: '/ProjectCoverImage/wordpress/motif3.png', thumb: '/ProjectCoverImage/wordpress/motif3.png', title: 'ภาพที่ 3' },
  ];
